...
export function InteractiveMatch() {
  ...
  // Dynamic 5v5 map scenarios generated per match
      ...
      <div className="w-full max-w-2xl space-y-5">
        ...
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          <Card className="p-4 border-gold-600/30">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                <span className="font-bold text-slate-200 text-sm font-heading uppercase">{interactiveMatch.opponentTeam?.shortName || 'RED'}</span>
                <div className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: interactiveMatch.opponentTeam?.color || '#ef4444' }} />
              </div>
            </div>
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className={`p-3.5 rounded-xl border flex items-center justify-between gap-3 ${
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-slate-300">{isCs ? matchup.reasonCs : matchup.reasonEn}</p>
                </div>
              </div>
          ...
          {step === 'minimap_radar' && (
            ...
            >
              <MinimapRadar onComplete={handleMinimapComplete} lang={language} />
            </motion.div>
          )}

          {/* STEP 3, 4, 5: 5v5 TACTICAL MAP BOARD SCENARIOS */}
